...
type
  ...
  TMQTTClient = class(TThread)
    private
       ...
       FLastControlSend: QWord;
       FLastControlRecv: QWord;
...
begin
  ...
  begin
    Message:=AMessage;
    SetCodePage(Message,1251);
    UTF8Message:= AnsiToUTF8(Message);
...
procedure TMQTTClient.SetLogFile(aValue:string);
begin
  FLogFile:=aValue;
  FLog.FileName:=FLogFile;
end;
{$endif FPC}
